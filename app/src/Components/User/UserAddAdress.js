...
import AddAdressHook from '../../hook/user/add-adress-hook';

const UserAddAdress = () => {
  const [press, loading, alias, details, phone, city, postalCode, onChangeAlias, onChangeDetails, onChangePhone, onChangeCity, onChangePostalCode, onSubmit] = AddAdressHook();
  return (
